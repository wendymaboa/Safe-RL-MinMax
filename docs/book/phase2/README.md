<div class="cover-kicker">Phase 2 · textbook map</div>
...
|---|---|---|
| **0** | Conda env that imports (`torch`, `transformers`, `peft`, `deepspeed`) | [01](/book/phase2/01-reset-and-cluster.md), [02](/book/phase2/02-lora-and-mkl.md) |
| **1** | LoRA plumbing verified at runtime | [02](/book/phase2/02-lora-and-mkl.md) |
| **2** | Prompt template + dataset path | [03](/book/phase2/03-template-and-ppo-loop.md) *(later reversed)* |
| **3** | End-to-end PPO smoke with LoRA | [03](/book/phase2/03-template-and-ppo-loop.md) |
| **4** | Reward vs cost probe | [04](/book/phase2/04-reward-cost-and-gpu.md) |
| **5** | Runs A / B / C | [05](/book/phase2/05-run-a.md)–[07](/book/phase2/07-run-c.md) |
...
|---|---|---|---|---|
| **A** | Reward only | Plain RLHF with no safety signal | Complete | [05-run-a](/book/phase2/05-run-a.md) |
| **B** | Reward + fixed `−2` when `cost > 0` | What *having* a safety signal buys | Complete + rescored | [06-run-b](/book/phase2/06-run-b.md) |
| **C** | Reward + MinMax when `cost > 0` | What self-calibration buys over a fixed penalty | Implemented; **not trained** | [07-run-c](/book/phase2/07-run-c.md) |
...
1. [Reset and cluster](/book/phase2/01-reset-and-cluster.md) — Sessions 1–3  
2. [LoRA and the MKL wall](/book/phase2/02-lora-and-mkl.md) — Sessions 4–7  
3. [Template and PPO loop](/book/phase2/03-template-and-ppo-loop.md) — Sessions 8–10  
4. [Reward, cost, and GPU estate](/book/phase2/04-reward-cost-and-gpu.md) — Sessions 11–13  
5. [Run A](/book/phase2/05-run-a.md) — Sessions 14–15  
6. [Run B](/book/phase2/06-run-b.md) — Sessions 16–17  
7. [Run C](/book/phase2/07-run-c.md) — Session 18  
...
| Run A / Run B | Archived; claims in [/book/10-claims.md](/book/10-claims.md) |
...
- Open questions: [/book/11-open-questions.md](/book/11-open-questions.md)  
