> **Source of truth:** `ppo_minmax_experiment/worklog.md` in the repo. This page is a Docsify mirror for GitHub Pages (the live `docs/` tree cannot fetch files outside itself). Edit the repo worklog, then run `python scripts/sync_worklogs_to_docs.py`.

# Phase 1 worklog — GPT-2 + Detoxify + MinMax
