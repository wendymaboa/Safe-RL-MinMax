...
**Become an expert (textbook)**  
Start at [/worklog/textbook/](/worklog/textbook/README.md) — ten concept chapters (transformers → RM/CM → PPO → Safe RLHF → MinMax → your A/B/C → reading results). Then return to the worklogs for the lab record.
